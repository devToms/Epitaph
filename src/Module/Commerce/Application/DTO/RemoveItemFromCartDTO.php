...
class RemoveItemFromCartDTO
{
    #[Assert\NotBlank(message: 'Product ID cannot be empty.')]
    #[OA\Property(type: 'integer', description: 'ID of the product')]
    #[Groups(['default'])]
    public readonly int $productId;

    #[Assert\NotBlank(message: 'Quantity is required.')]
    #[Assert\Positive(message: 'Quantity must be a positive number.')]
    #[OA\Property(type: 'integer', description: 'Quantity of the product to remove')]
    #[Groups(['default'])]
